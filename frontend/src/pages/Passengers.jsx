...
const Passengers = () => {
  const initialPassengers = [
    ...
    { id: 2, name: 'Fatima Yasin', phone: '+966501234002', email: 'fatima.yasin@example.com', flightDate: '2023-06-02', station: 'RUH' },
    { id: 3, name: 'Hassan Ali', phone: '+966501234003', email: 'hassan.ali@example.com', flightDate: '2023-06-03', station: 'DXB' },
    { id: 4, name: 'Layla Ahmed', phone: '+966501234004', email: 'layla.ahmed@example.com', flightDate: '2023-06-04', station: 'KRT' },
    { id: 5, name: 'Omar Kareem', phone: '+966501234005', email: 'omar.kareem@example.com', flightDate: '2023-06-05', station: 'JED' },
    { id: 6, name: 'Sara Hamza', phone: '+966501234006', email: 'sara.hamza@example.com', flightDate: '2023-06-06', station: 'RUH' },
    { id: 7, name: 'Yousef Nabil', phone: '+966501234007', email: 'yousef.nabil@example.com', flightDate: '2023-06-07', station: 'DXB' },
    { id: 8, name: 'Noor Hassan', phone: '+966501234008', email: 'noor.hassan@example.com', flightDate: '2023-06-08', station: 'KRT' },
    { id: 9, name: 'Ali Tarek', phone: '+966501234009', email: 'ali.tarek@example.com', flightDate: '2023-06-09', station: 'JED' },
    { id: 10, name: 'Mona Abdullah', phone: '+966501234010', email: 'mona.abdullah@example.com', flightDate: '2023-06-10', station: 'RUH' },
    { id: 11, name: 'Khalid Younis', phone: '+966501234011', email: 'khalid.younis@example.com', flightDate: '2023-06-11', station: 'DXB' },
    { id: 12, name: 'Rania Fathi', phone: '+966501234012', email: 'rania.fathi@example.com', flightDate: '2023-06-12', station: 'KRT' },
    { id: 13, name: 'Ibrahim Sami', phone: '+966501234013', email: 'ibrahim.sami@example.com', flightDate: '2023-06-13', station: 'JED' },
    { id: 14, name: 'Salma Bilal', phone: '+966501234014', email: 'salma.bilal@example.com', flightDate: '2023-06-14', station: 'RUH' },
    { id: 15, name: 'Zainab Omar', phone: '+966501234015', email: 'zainab.omar@example.com', flightDate: '2023-06-15', station: 'DXB' },
    { id: 16, name: 'Mustafa Zaki', phone: '+966501234016', email: 'mustafa.zaki@example.com', flightDate: '2023-06-16', station: 'KRT' },
    { id: 17, name: 'Dina Adel', phone: '+966501234017', email: 'dina.adel@example.com', flightDate: '2023-06-17', station: 'JED' },
    { id: 18, name: 'Tariq Latif', phone: '+966501234018', email: 'tariq.latif@example.com', flightDate: '2023-06-18', station: 'RUH' },
    { id: 19, name: 'Nadia Sherif', phone: '+966501234019', email: 'nadia.sherif@example.com', flightDate: '2023-06-19', station: 'DXB' },
    { id: 20, name: 'Mahmoud Essam', phone: '+966501234020', email: 'mahmoud.essam@example.com', flightDate: '2023-06-20', station: 'KRT' },
    { id: 21, name: 'Amina Jamal', phone: '+966501234021', email: 'amina.jamal@example.com', flightDate: '2023-06-21', station: 'JED' },
    { id: 22, name: 'Bilal Hani', phone: '+966501234022', email: 'bilal.hani@example.com', flightDate: '2023-06-22', station: 'RUH' },
    { id: 23, name: 'Reem Tamer', phone: '+966501234023', email: 'reem.tamer@example.com', flightDate: '2023-06-23', station: 'DXB' },
    { id: 24, name: 'Nabil Farouk', phone: '+966501234024', email: 'nabil.farouk@example.com', flightDate: '2023-06-24', station: 'KRT' },
    { id: 25, name: 'Samar Ghali', phone: '+966501234025', email: 'samar.ghali@example.com', flightDate: '2023-06-25', station: 'JED' },
    { id: 26, name: 'Rami Waleed', phone: '+966501234026', email: 'rami.waleed@example.com', flightDate: '2023-06-26', station: 'RUH' },
    { id: 27, name: 'Huda Nasser', phone: '+966501234027', email: 'huda.nasser@example.com', flightDate: '2023-06-27', station: 'DXB' },
    { id: 28, name: 'Ziad Hossam', phone: '+966501234028', email: 'ziad.hossam@example.com', flightDate: '2023-06-28', station: 'KRT' },
    { id: 29, name: 'Ahlam Reda', phone: '+966501234029', email: 'ahlam.reda@example.com', flightDate: '2023-06-29', station: 'JED' },
    { id: 30, name: 'Wael Bassem', phone: '+966501234030', email: 'wael.bassem@example.com', flightDate: '2023-06-30', station: 'RUH' },
    { id: 31, name: 'Nisreen Salah', phone: '+966501234031', email: 'nisreen.salah@example.com', flightDate: '2023-07-01', station: 'DXB' },
    { id: 32, name: 'Kareem Mounir', phone: '+966501234032', email: 'kareem.mounir@example.com', flightDate: '2023-07-02', station: 'KRT' },
    { id: 33, name: 'Rasha Taha', phone: '+966501234033', email: 'rasha.taha@example.com', flightDate: '2023-07-03', station: 'JED' },
    { id: 34, name: 'Tamer Fouad', phone: '+966501234034', email: 'tamer.fouad@example.com', flightDate: '2023-07-04', station: 'RUH' },
    { id: 35, name: 'Hana Mostafa', phone: '+966501234035', email: 'hana.mostafa@example.com', flightDate: '2023-07-05', station: 'DXB' },
    { id: 36, name: 'Samir Adnan', phone: '+966501234036', email: 'samir.adnan@example.com', flightDate: '2023-07-06', station: 'KRT' },
    { id: 37, name: 'Walaa Samy', phone: '+966501234037', email: 'walaa.samy@example.com', flightDate: '2023-07-07', station: 'JED' },
    { id: 38, name: 'Ayman Fadel', phone: '+966501234038', email: 'ayman.fadel@example.com', flightDate: '2023-07-08', station: 'RUH' },
    { id: 39, name: 'Hala Zain', phone: '+966501234039', email: 'hala.zain@example.com', flightDate: '2023-07-09', station: 'DXB' },
    { id: 40, name: 'Fady Nour', phone: '+966501234040', email: 'fady.nour@example.com', flightDate: '2023-07-10', station: 'KRT' },
    { id: 41, name: 'Nada Saad', phone: '+966501234041', email: 'nada.saad@example.com', flightDate: '2023-07-11', station: 'JED' },
    { id: 42, name: 'Adel Mustafa', phone: '+966501234042', email: 'adel.mustafa@example.com', flightDate: '2023-07-12', station: 'RUH' },
    { id: 43, name: 'Lina Rauf', phone: '+966501234043', email: 'lina.rauf@example.com', flightDate: '2023-07-13', station: 'DXB' },
    { id: 44, name: 'Nader Fouzi', phone: '+966501234044', email: 'nader.fouzi@example.com', flightDate: '2023-07-14', station: 'KRT' },
    { id: 45, name: 'Jana Riyad', phone: '+966501234045', email: 'jana.riyad@example.com', flightDate: '2023-07-15', station: 'JED' },
    { id: 46, name: 'Ola Fathi', phone: '+966501234046', email: 'ola.fathi@example.com', flightDate: '2023-07-16', station: 'RUH' },
    { id: 47, name: 'Malik Sherif', phone: '+966501234047', email: 'malik.sherif@example.com', flightDate: '2023-07-17', station: 'DXB' },
    { id: 48, name: 'Areej Jamal', phone: '+966501234048', email: 'areej.jamal@example.com', flightDate: '2023-07-18', station: 'KRT' },
    { id: 49, name: 'Hatem Emad', phone: '+966501234049', email: 'hatem.emad@example.com', flightDate: '2023-07-19', station: 'JED' },
    { id: 50, name: 'Yara Hamid', phone: '+966501234050', email: 'yara.hamid@example.com', flightDate: '2023-07-20', station: 'RUH' },
    { id: 51, name: 'Abdul Hamid', phone: '+966501234050', email: 'yara.hamid@example.com', flightDate: '2023-07-20', station: 'RUH' },
  ];
